...
function includeTweens () {
	...
	//Tweens
	var tween_1 = TweenMax.fromTo("#event_1", 0.5, {left: -1000,}, {left: -142, repeat: 0, ease: Circ.easeInOut}),
		tween_2 = TweenMax.fromTo("#event_2", 0.5, {right: -1000,}, {right: -65, repeat: 0, ease: Circ.easeInOut}),
		tween_3 = TweenMax.fromTo("#event_3", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
		tween_4 = TweenMax.fromTo("#event_4", 0.5, {left: -1000,}, {left: -62, repeat: 0, ease: Circ.easeInOut}),
		tween_5 = TweenMax.fromTo("#event_5", 0.5, {right: -1000,}, {right: -90, repeat: 0, ease: Circ.easeInOut}),
		tween_6 = TweenMax.fromTo("#event_6", 0.5, {left: -1000,}, {left: -48, repeat: 0, ease: Circ.easeInOut}),
		tween_7 = TweenMax.fromTo("#event_7", 0.5, {right: -1000,}, {right: -96, repeat: 0, ease: Circ.easeInOut}),
		tween_8 = TweenMax.fromTo("#event_8", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
		tween_9 = TweenMax.fromTo("#event_9", 0.5, {right: -1000,}, {right: -96, repeat: 0, ease: Circ.easeInOut}),
		tween_10 = TweenMax.fromTo("#event_10", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
		tween_11 = TweenMax.fromTo("#event_11", 0.5, {right: -1000,}, {right: -96, repeat: 0, ease: Circ.easeInOut}),
		tween_12 = TweenMax.fromTo("#event_12", 0.5, {left: -1000,}, {left: -48, repeat: 0, ease: Circ.easeInOut}),
		// tween_13 = TweenMax.fromTo("#event_13", 1, {right: -1000,}, {right: -92, repeat: 0, ease: Circ.easeInOut}),
		tween_14 = TweenMax.fromTo("#event_14", 0.5, {left: -1000,}, {left: -48, repeat: 0, ease: Circ.easeInOut}),
		tween_15 = TweenMax.fromTo("#event_15", 0.5, {right: -1000,}, {right: -92, repeat: 0, ease: Circ.easeInOut}),
		// tween_16 = TweenMax.fromTo("#event_16", 1, {right: -1000,}, {right: -92, repeat: 0, ease: Circ.easeInOut}),
		tween_17 = TweenMax.fromTo("#event_17", 0.5, {right: -1000,}, {right: -92, repeat: 0, ease: Circ.easeInOut}),
		tween_18 = TweenMax.fromTo("#event_18", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
		tween_19 = TweenMax.fromTo("#event_19", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
		tween_20 = TweenMax.fromTo("#event_20", 0.5, {left: -1000,}, {left: -61, repeat: 0, ease: Circ.easeInOut}),
		tween_21 = TweenMax.fromTo("#event_21", 0.5, {left: -1000,}, {left: -60, repeat: 0, ease: Circ.easeInOut}),
		tween_22 = TweenMax.fromTo("#event_22", 0.5, {right: -1000,}, {right: -89, repeat: 0, ease: Circ.easeInOut}),
		tween_23 = TweenMax.fromTo("#event_23", 0.5, {autoAlpha:0}, {autoAlpha:1, repeat: 0, ease: Circ.easeInOut}),
